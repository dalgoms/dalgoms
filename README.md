...
아이디어를 실제 실행 구조로 바꾸는 일을 좋아합니다.

광고 및 자사 서비스와 솔루션을 운영하고, 흐름을 설계하고, 반복 업무를 자동화하면서  
전략이 실제 결과로 이어지도록 만드는 데 집중해왔습니다.  
이 저장소는 그 과정에서 만든 서비스, 시스템, 도구를 정리한 포트폴리오 허브입니다.
> 14x 리드 성장 · 8 서비스 운영 경험 · 250+ 기업 고객(Timblo) · 10년+ 경력
