...
복잡한 일을 정리하고, 실행 가능한 구조로 바꾸는 일을 좋아합니다.

광고와 자사 서비스, 솔루션을 운영하면서
흐름을 설계하고 반복 업무를 자동화해
전략이 실제 결과로 이어지도록 만드는 데 집중해왔습니다.

이 저장소는 그 과정에서 직접 만든 서비스, 시스템, 도구를 모은 포트폴리오 허브입니다.
> 14x 리드 성장 · ROAS 800% 경험 · 250+ 기업 고객(Timblo) · 10년+ 경력
