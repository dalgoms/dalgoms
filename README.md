...
병목이 생기는 지점을 구조적으로 정리하고,  
더 쉽고 빠르게 실행되는 흐름으로 바꾸는 일을 해왔습니다.

광고, 자사 서비스, 솔루션을 운영하며  
반복 업무는 시스템과 자동화로 정리하고,  
실행 속도와 생산성을 높여  
전략이 실제 결과로 이어지도록 만드는 데 집중해왔습니다.

그 과정에서 확보한 여유는  
신규 기획과 더 나은 운영 구조를 만드는 데 다시 투자해왔습니다.  
같은 방향의 문제의식을 가진 팀과 함께할 때 더 큰 시너지를 냅니다.

> **14x** 리드 성장 · **8x** ROAS · **250+** 기업 고객(Timblo) · **10년+** 경력
---
...
| Status | 프로젝트 | 문제 | 해결 |
|---|---|---|---|
| LIVE | [WebScout](https://webscout-next-8veo.vercel.app/) | 경쟁사 구조 파악에 수일 | 자동 크롤링 → 시각화, 수시간 |
| LIVE | [Ad Creative Tool](https://ad-creative-tool.vercel.app) | 소재 반복 제작 | AI 카피 + 자동 멀티포맷 |
| LIVE | [MEFIMAKE](https://mefimake.vercel.app/) | 광고 소재 수작업 | AI 카피 변형 + 시간 절감 |
| INT | Biz Automation | 리드~팔로업 수동 | Make.com + Notion CRM 자동 |
...
**Growth Marketing Lead · timbel · 10+ years**
...
이곳은 그 과정에서 직접 만들고 운영한 서비스, 시스템, 도구를 정리한 포트폴리오 허브입니다.

> **14x** lead growth · **8x ROAS** · **250+** business customers (Timblo) · **10+** years
