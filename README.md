...
* 10년+ 마케팅 전략 수립 및 리드 파이프라인 시스템 자동화 경력 

---

## What I Do
**양적 팽창을 넘어 질적 최적화로, 데이터 기반의 '완결형 UX'를 설계합니다.**

단순히 트래픽을 데려오는 것에 그치지 않고, 유입된 사용자가 이탈 없이 비즈니스 가치로 전환되는 '마찰 없는 경험'을 구축합니다. 2025년 한 해 동안 300만 건 이상의 모바일 트래픽을 운영하며, 98%에 육박하는 모바일 사용자의 행동 패턴을 분석해 최적의 랜딩 페이지 구조를 도출했습니다.

광고 클릭 직후 발생하는 **90%의 이탈(Bounce)**과 같은 데이터 병목을 정밀하게 진단하여, 정보 습득과 전환이 한 번에 해결되는 One-page UX 시스템을 지향합니다. 반복적인 운영 리소스는 자동화로 효율화하고, 확보된 여유를 SEO 및 오가닉 채널 복구 등 지속 가능한 성장을 위한 중장기 전략에 재투자합니다. 데이터가 단순한 숫자를 넘어 실제 비즈니스의 자산이 되도록 실행의 속도를 압도적으로 높이는 데 진심입니다.
