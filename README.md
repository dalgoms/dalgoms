...
속기 전문 회사에서 시작해서, 회사가 AI 음성인식으로 바뀌는 과정을 10년간 안에서 겪었습니다. 제품이 바뀌면 고객이 바뀌고, 파는 방식도 바뀝니다 — 그때마다 웹사이트, 리드 시스템, 캠페인 구조를 직접 다시 만들었습니다. 2022년에 생성형 AI가 나온 뒤로는 광고 소재, 랜딩페이지, 캠페인 카피에 바로 적용해서 테스트 속도를 끌어올렸고, 지금은 직접 만든 AI 도구를 실무에서 매일 쓰고 있습니다.
