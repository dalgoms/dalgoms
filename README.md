...
## What I Do
**"병목을 해결하고, 실행의 속도를 설계합니다."**

복잡하게 얽힌 운영 프로세스의 병목 지점을 구조적으로 진단하고, 이를 '쉽고 빠른 실행 흐름'으로 전환하는 데 집중해 왔습니다. 광고부터 자사 서비스 운영까지, 반복 업무를 시스템과 자동화로 대체하여 팀의 생산성을 극대화합니다.

효율화를 통해 확보한 리소스는 다시 신규 기획과 더 정교한 운영 구조를 만드는 데 투자합니다. 단순한 실행을 넘어, 전략이 반드시 '숫자'라는 결과로 이어지는 선순환 구조를 구축하며, 같은 문제의식을 공유하는 팀과 폭발적인 시너지를 냅니다.
---
