...
전략을 세우고, 구조를 만들고, 직접 실행합니다.

분석 기반 기획에서 웹사이트 운영, AI 자동화까지 — 비즈니스 전 과정을 설계하고 실행합니다.
8개 라이브 서비스를 동시에 기획·운영하며, AI를 실행 가속기로 활용해 병목을 줄이고 반복 업무를 시스템으로 전환합니다.

> **14x** 매출/리드 성장 (23–25) · **8** 라이브 서비스 운영 · **250+** 기업 고객 (Timblo) · **10+** 년 경력
